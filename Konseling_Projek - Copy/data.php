<?php
include "koneksi.php";   // 🔹 koneksi dipanggil lewat include

// Query ambil data
$sql = "
SELECT 
    matriks.idmatriks,
    identitas.nama AS nama_siswa,
    kriteria.namakriteria AS nama_kriteria,
    matriks.value AS nilai
FROM matriks
LEFT JOIN identitas ON matriks.ididentitas = identitas.ididentitas
LEFT JOIN kriteria ON matriks.idkriteria = kriteria.idkriteria
ORDER BY matriks.idmatriks ASC
";
